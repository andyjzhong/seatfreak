...
const Navbar = (props) => {
    ...
    return (
        <div className="navbar" style={(width <= 800) ? {backgroundColor: "white"} : (window.location.href.indexOf("search") !== -1) ? {backgroundColor: "white"} : {backgroundColor: "rgba(255, 255, 255, 0)"}}>
            <Link to={`/`}>
